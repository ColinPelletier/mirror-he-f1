...
WebUI.click(findTestObject('Object Repository/Page_Home - HE-F1/a_Your notifications'))

WebUI.click(findTestObject('Object Repository/Page_Notifications - HE-F1/input_name_btn btn-outline-success my-2 my-_3d16f2'))
