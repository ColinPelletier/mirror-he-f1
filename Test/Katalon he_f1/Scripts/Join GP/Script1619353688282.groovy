...
WebUI.click(findTestObject('Object Repository/Page_Home - HE-F1/a_Grands Prix'))

WebUI.click(findTestObject('Object Repository/Page_Grand Prix - HE-F1/button_Lets race'))
