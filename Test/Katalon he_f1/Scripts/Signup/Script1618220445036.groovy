...
WebUI.click(findTestObject('Object Repository/Page_HE-F1/label_Spcialisation'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_HE-F1/select_ManageurIngnieurMcanicien'), 'MANAGER', true)
